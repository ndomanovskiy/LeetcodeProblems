...
{
    /// <summary>
    /// String to Integer (atoi): Implement the myAtoi(string s) function, which converts a string
    ...
    {
        if (s is null || s.Length < 0 || s.Length > 200) throw new ArgumentException(message: nameof(s));
